    ...
    <dl class="s-item">
        ...
        <dd>
            ...
            <p>
                ...
                ></el-rate>
                <span v-if="meta.scote > 4.5">很好</span>
                <span v-else-if="meta.scote > 4">好</span>
                <span v-else-if="meta.scote > 3.5">不错</span>
                <span v-else-if="meta.scote > 3">一般</span>
                <span v-else-if="meta.scote > 3">好</span>
            ...
            <ul class="deal-items">
                <li class="items" v-for="(item,index) in meta.dealItems.slice(0,2)" :key="index">
                    ...
                    <p>
                        ...
                        <span class="deal_sales">已售{{item.saleNum}}</span>
                    </p>
                </li>
            </ul>
        </dd>
